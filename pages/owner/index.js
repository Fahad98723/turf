                ...
                <table className="w-full">
                  <thead className="">
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                      <th
                        scope="col"
                        className="  text-[#ABABAB] px-6 py-4 text-left"
                      >
                        Name
                      </th>
                      <th
                  ...
                  <tbody className="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    {bookings.map((b) => (
                      <tr className="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                        ...
                        <td className=" font-medium px-6 py-4">
                          <div className="flex flex-col ">৳ {b.payment}</div>
                        </td>
                    ...
                    <tr className="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                      <td className=" font-medium px-6 py-4 whitespace-nowrap"></td>
                      <td className=" font-medium px-6 py-4 whitespace-nowrap"></td>
                      <td className=" font-medium px-6 py-4 whitespace-nowrap"></td>
                      <td className=" font-medium px-6 py-4 whitespace-nowrap">
                        <p>Total</p>
                      ...
                      <td className=" font-medium px-6 py-4">
                        <div className="flex flex-col ">৳ 50000</div>
                      </td>
                      <td className=" font-medium px-6 py-4 flex items-center">
                        {/* <div
                        onClick={(e) => setConfirmPage(true)}
